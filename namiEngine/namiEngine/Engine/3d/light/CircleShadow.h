...
public: // メンバ関数
	...
	inline void SetDir(const XMVECTOR& dir) { this->lightDir = DirectX::XMVector3Normalize(dir); }

	/// <summary>
	/// ライト方向を取得
	/// </summary>
	/// <returns>ライト方向</returns>
	inline const XMVECTOR& GetDir() { return lightDir; }

	/// <summary>
	/// キャスター座標をセット
	/// </summary>
	/// <param name="pos">キャスター座標</param>
	...
	/// キャスターとライトの距離をセット
	/// </summary>
	/// <param name="distance">キャスターとライトの距離</param>
	inline void SetDistanceCasterLight(float distance) { this->distanceCasterLight = distance; }
	...
	inline void SetAtten(const XMFLOAT3& attenuation) { this->lightAtten = attenuation; }

	/// <summary>
	/// 距離減衰係数を取得
	/// </summary>
	/// <returns>ライト距離減衰係数</returns>
	inline const XMFLOAT3& GetAtten() { return lightAtten; }
...
private: // メンバ変数
	...
	// 距離減衰係数
	XMFLOAT3 lightAtten = { 0.5f, 0.6f, 0.0f };
	// 減衰角度
